...
const Balance = ({
  ...
  const { months, series, date, balance } = useTransactionSeries(
    transactions as any,
  );
  ...
  return (
    <Card className="flex flex-col lg:flex-row lg:gap-20">
      <aside className="flex h-full w-fit flex-col whitespace-nowrap">
        ...
        >
          <span className="withespace-nowrap mt-4 text-4xl font-semibold">
