  ...
  return (
    <div className="flex h-screen flex-row overflow-hidden bg-default-100 md:p-1.5 md:pl-0 dark:bg-slate-900">
      <AnimatePresence>
        ...
        <section className="   z-0  h-full w-full flex-grow overflow-y-auto rounded-md rounded-tl-2xl border bg-white py-3   scrollbar-hide dark:border-white/10 dark:bg-slate-950">
