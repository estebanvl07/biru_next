...
const SideBar = ({ serviceOptions = true, className }: SideBarProps) => {
  return (
    <div
      className={clsx(
        "fixed left-0 top-0 z-20 hidden h-screen w-60 flex-col justify-between border-r border-slate-200 bg-white dark:bg-default-100 pb-4 pt-2 text-white/80 md:flex dark:border-white/10 dark:bg-slate-950",
        className,
      )}
    >
